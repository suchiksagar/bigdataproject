...
java -jar /opt/kafkaconsumer/weatherkafkaconsumer.jar --kafka.bootstrapAddress=${DOCKER_HOST} --elastic.bootstrapAddress=${ELASTIC_HOST} --userlog.topic.name=${KAFKA_TOPIC}